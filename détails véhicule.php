    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p><?php echo htmlentities($result->PricePerDay);?> </p> Dinar Tunisien Par jour
...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="share_vehicle">
          <p>Share: <a href="https://www.facebook.com/location.de.voiture.djerba.service"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>  </p>
        </div>
