...
<head>
	...
	<title>Location de voitures | Administrateur gére Image 2</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Véhicule Image 2 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Détails véhicule Image 2</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Image actuelle 2</label>
<?php 
$id=intval($_GET['imgid']);
