...
<head>
	...
	<title>Location de voitures | Administrateur gére Image 5</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Véhicule Image 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Détails véhicule Image 5</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Image actuelle 5</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Télécharger une nouvelle image 5<span style="color:red">*</span></label>
												<div class="col-sm-8">
